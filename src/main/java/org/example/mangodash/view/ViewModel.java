    ...
    public ViewModel(String viewName) {
        ...
        try {
            comfortaaBig = Font.createFont(Font.TRUETYPE_FONT,
                    new File("src/main/resources/Fonts/Comfortaa.ttf")).deriveFont(50f);
            comfortaaMedium = Font.createFont(Font.TRUETYPE_FONT,
                    new File("src/main/resources/Fonts/Comfortaa.ttf")).deriveFont(30f);
            comfortaaSmall = Font.createFont(Font.TRUETYPE_FONT,
                    new File("src/main/resources/Fonts/Comfortaa.ttf")).deriveFont(20f);
